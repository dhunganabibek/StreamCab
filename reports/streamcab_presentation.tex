...
\begin{itemize}
  \item[$\checkmark$] \textbf{Code Links:} \url{https://github.com/dhunganabibek/StreamCab}
  \item[$\checkmark$] \textbf{Data source:} \url{www.nyc.gov/site/tlc/about/tlc-trip-record-data.page}
  \item[$\checkmark$] Final report in IEEE research paper style
